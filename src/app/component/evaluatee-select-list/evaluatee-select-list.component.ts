...
@Component({
  ...
  templateUrl: './evaluatee-select-list.component.html',
  styleUrls: ['./evaluatee-select-list.component.css']
})
export class EvaluateeSelectListComponent implements OnInit, HasteCallback<Evaluatee> {
